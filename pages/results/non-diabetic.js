      ...
      <div className="bg-green-200 relative h-screen w-full text-black">
        ...
        <div className="flex justify-center items-center h-full">
          ...
          <div className="flex-1 text-center space-y-4 mr-20">
            ...
            <p className="">Great news! You have an {probability} chance of not being diabetic. </p>
            <p className="text-2xl">
              Rest assured, we are here to support you in maintaining your health and well-being. Even with a lower risk, our platform is dedicated to guiding you toward a healthier future. Let's work together for your continued well-being.
            </p>
